...
<style>
.two-lines {
	@apply after:block after:h-[1px] after:w-[120px] after:bg-[#71717A] after:content-[''];
	@apply before:block before:h-[1px] before:w-[120px] before:bg-[#71717A] before:content-[''];
}
</style>
